!! Description: 
!! The module declares functions for boundary condition.
!! Inputs for functions involve a state variable, location, flag and time. 
!! Extra parameters for computing functions will be set up at main.f90
! Current Code Owner: SIMCOFlow
!
! Code Description: 
! Language: Fortran 90
! Software Standards: "European Standards for Writting and 
...
MODULE BoundaryFunction
  ...
  TYPE, PUBLIC :: BCBase 
    ...
    CONTAINS
      ...
      PROCEDURE, PASS(this), PUBLIC :: SetDN
      PROCEDURE, PASS(this), PUBLIC :: SetConstant  
  END TYPE BCBase
  ...
  SUBROUTINE Construct(this,Isize,Jsize)
